...
simulation_name_tag <- if (IS_TF_SIMULATION) "TF2_PePr_Sim" else "HM1_PePr_Sim"
...
if (IS_TF_SIMULATION) {
  ...
  sim_params <- list(
    fraglen = 500,      # Fragment length for simulation (distinct from PePr's fraglen for shift)
    base.mu = 120,
    up.mu = 180,
    down.mu.1 = 60,
    down.mu.2 = 60,
